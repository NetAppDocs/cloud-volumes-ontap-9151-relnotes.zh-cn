...
9.15.1 P14 补丁现已可供所有云提供商的Cloud Volumes ONTAP使用。NetApp Console将提示您将现有系统升级到此补丁版本。
...
9.15.1 P13 补丁现已可供所有云提供商的Cloud Volumes ONTAP使用。NetApp Console将提示您将现有系统升级到此补丁版本。
